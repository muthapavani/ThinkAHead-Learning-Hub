const COURSES_DATA = [
  {
    ...
    fullDescription: 'Ground-breaking course crafted from 200+ collective years of industrial executive leadership experience. Learn how to discover your core strengths, articulate strategic visions, align personal purpose with organizational missions, and command genuine respect',
      ...
      questions: [
        {
          ...
          correctAnswer: 0,
          explanation: 'Integrity & Values is heavily weighted at 15% in employer evaluations,'
        },
        {
          id: 'q1-2',
    ...
    modules: [
      {
        ...
        lessons: [
          ...
          },
          {
            ...
            videoUrl: 'https://commondatastorage.googleapis.com/gtv-videos-bucket/sample/ElephantsDream.mp4',
            description: 'Deep listening, mentorship, and building unwavering client trust.',
            keyPoints: [
        ...
        lessons: [
          {
            ...
            videoUrl: 'https://commondatastorage.googleapis.com/gtv-videos-bucket/sample/BigBuckBunny.mp4',
            description: 'Why being busy is not the same, automating, and eliminating.',
  ...
  },
  {
    ...
    quiz: { id: 'quiz-8', title: 'Learning Agility Examination', durationMinutes: 15, passingScorePercentage: 70, questions: [{ id: 'q8-1', question: 'What is the core mechanic of the Feynman Technique?', options: ['Memorizing complex terms without understanding', 'Explaining concepts in plain language', 'Copying textbook diagrams', 'Reading silently without testing recall'], correctAnswer: 1, explanation: 'The Feynman technique forces you to clarify concepts in straightforward, intuitive language.' }] }
  },
  {
    id: 'course-9',
    ...
    assignments: [{ id: 'asg-9-1', title: 'Reframe a Major Career Setback', dueDate: 'Due in 5 Days', points: 100, description: 'Document a painful past failure. Identify the hidden advantages, skills acquired, and character traits developed', guidelines: ['List 3 permanent lessons gained', 'Explain how it shaped your present capability'] }],
    quiz: { id: 'quiz-9', title: 'Mindset & Resilience Test', durationMinutes: 15, passingScorePercentage: 70, questions: [{ id: 'q9-1', question: 'How does a growth mindset differ from a fixed mindset when encountering criticism?', options: ['Growth mindset views criticism', 'Growth mindset gets offended and defensive', 'Fixed mindset takes immediate corrective action', 'Both react identically'], correctAnswer: 0, explanation: 'Growth mindset welcomes criticism' }] }
  },
  {
    id: 'course-10',
  ...
  },
  {
    ...
    learningOutcomes: ['Navigate grey ethical dilemmas in high-stakes commerce', 'Establish transparent accounting and moral safeguards', 'Command authentic moral authority'],
